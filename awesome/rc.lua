...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        gears.wallpaper.maximized("/usr/share/slim/themes/slim-minimal/background.jpg", s, true)
    end
end
-- }}}
...
client.connect_signal("manage", function (c, startup)
    ...
    -- Remove gap between windows, escpecially on the right and bottom of a terminal when only window
