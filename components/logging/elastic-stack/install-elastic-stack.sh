...
# Logspout: Send docker containers logs to logstash
    process_docker_compose_service logging/elastic-stack/logspout ""
...
# Logstash: Centralise logs and send them to elasticsearch
    ...
    process_docker_compose_service logging/elastic-stack/logstash "$(declare -p logstash_docker_compose_template_mappings)"
...
# Elasticsearch: Search engine
    ...
    process_docker_compose_service logging/elastic-stack/elasticsearch "$(declare -p elasticsearch_docker_compose_template_mappings)"
...
# Kibana: Web UI for analysing elastic search content
    ...
    process_docker_compose_service logging/elastic-stack/kibana "$(declare -p kibana_docker_compose_template_mappings)"
